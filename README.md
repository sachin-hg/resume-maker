...
| `## Skills` | `Skill \| Rating, Skill \| Rating` — comma-separated, rating 1–5 | Either **all** skills have a rating (rated bar mode) or **none** do (chip mode). Mixing causes inconsistent UI. |
